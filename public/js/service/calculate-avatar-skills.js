(function(angular) {
  ...
  .factory("CalculateSkillsService", ['$http', ($http) => {
    ...
    const calculate = (avatar) => {
      ...
      const hp = ((information.commits + streak) * information.commitsAvarage) + ((information.fallowers + information.fallowing + information.stars) * information.organizations);
      ...
      const accuracy = ((information.fallowers + information.fallowing) * information.organizations);
